...
function recoveryEmailHtml(c, { outageStart, now } = {}) {
  ...
  const wordmark = c.siteUrl
    ? `<img src="${c.siteUrl}/assets/email-wordmark-claude@2x.png" width="240" height="48" alt="${c.siteUrl.replace(/^https?:\/\//, "")}" style="display:block;margin:0 auto 20px;border:0;outline:none;text-decoration:none">`
    : "";
  ...
  return `<!DOCTYPE html><html><body style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;background:#0f0f12;color:#eaeaf0;padding:32px">
    <div style="max-width:480px;margin:0 auto;text-align:center">
      ...
      <p style="color:#a8a8b8;font-size:16px;line-height:1.5;margin:0 0 12px">The official status page is reporting all systems operational again.</p>
      ${outage}
